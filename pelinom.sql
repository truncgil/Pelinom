...
--
-- Anamakine: localhost
-- Üretim Zamanı: 25 Kas 2018, 05:44:07
...
CREATE TABLE `feeds` (
  ...
  `encoded` text COLLATE utf8_turkish_ci,
  `img` text COLLATE utf8_turkish_ci
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `other` (
  ...
  `deger` text COLLATE utf8_turkish_ci
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `translate` (
  ...
  `i` text COLLATE utf8_turkish_ci,
  `t` text COLLATE utf8_turkish_ci
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `uyeler` (
  ...
  `altbilgi` text COLLATE utf8_turkish_ci,
  `ustbilgi` text COLLATE utf8_turkish_ci,
  `biyografi` text COLLATE utf8_turkish_ci,
  `brans` varchar(255) COLLATE utf8_turkish_ci DEFAULT NULL,
  `cover` varchar(255) COLLATE utf8_turkish_ci DEFAULT NULL,
  `date` datetime DEFAULT NULL,
  `adresler` text COLLATE utf8_turkish_ci,
